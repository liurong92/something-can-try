// 由于跨域问题， 因此在运行该例子是，需要启动服务，以便于项目的运行，在此，我使用的是`python -m SimpleHTTPServer 8888 &`来启动服务

d3.csv('data.csv', type, function (data) {
  var width = 1000,
      height = 500,
      margin = {left: 30, right: 30, top: 30, buttom:30},
      svg_width = width + margin.left + margin.right,
      svg_height = height + margin.top + margin.buttom;
